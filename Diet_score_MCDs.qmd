...
years   <- c("2005","2007","2009","2011","2013","2015","2017P")
suffix  <- c("_D","_E","_F","_G","_H","_I","_P") # _P for 2017-Mar2020
cycles  <- c("0506","0708","0910","1112","1314","1516","1720")

# Groups of variables
demo_cols   <- c("RIAGENDR","RIDAGEYR","SDMVSTRA","SDMVPSU",
                 "WTMEC2YR","DMDEDUC2",        # 2-year weights (2005-2016)
...
demo_health_0520 <- demo_health_0520 %>%
...
demo_health_0518 <- read_csv("DATA/demo_health_0520.csv", show_col_types = FALSE)
```
